...
namespace Application.Client.CongNo
{
    public class PublicCongNoService : IPublicCongNoServicer
    {
        ...
        public PublicCongNoService(CodeDbContext context/*, IStorageService storageService*/)
        {
            _context = context;
        ...
        public async Task<int> Delete(int CongNoID)
        {
            ...
            if (_congno == null) throw new CodeExt($"Cannot find a product: {CongNoID}");
        ...
        public async Task<int> Update(CongNoUpdateRequest x)
        {
            ...
            if (_congno == null) throw new CodeExt($"Cannot find a product with id: {x.CtrCongNoID}");
            {
