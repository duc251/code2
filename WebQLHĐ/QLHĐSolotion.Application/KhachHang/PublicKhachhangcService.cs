...
namespace QLHĐSolotion.Application.KhachHang
{
    public class PublicKhachHangService : IPublicKhachHangServicer
    {
        ...
        public PublicKhachHangService(AppDbContext context/*, IStorageService storageService*/)
        {
            _context = context;
        ...
        public async Task<int> Update(CtrKhachHangUpdateRequest x)
        {
            ...
            if (product == null) throw new AddException($"Cannot find a product with id: {x.CtrKhachHangID}");
